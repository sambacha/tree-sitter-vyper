...
let stats = {
  ...
  //  initialRuleCount: Object.keys(pythonGrammar.rules).length,
    initialRuleCount: Object.keys(pythonGrammar.rules || pythonGrammar.definition?.rules || {}).length,
    finalRuleCount: 0,
};
...
// Output the grammar to grammar.js
fs.writeFileSync('./vyper_grammar.js', `module.exports = ${JSON.stringify(vyperGrammar, null, 2)};`, 'utf8');
console.log(JSON.stringify(vyperGrammar, null, 2));
// Output statistics
